...
Frankish calls this the illusion problem and treats it as the successor
...
denial is a poor instrument for a comparative question. If the report of experience is false,
...
only the named part, and a thought experiment is such an environment, which is why thought
...
here, because the two substrates being compared are the two candidate reference machines.
