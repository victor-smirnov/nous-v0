...
\item \emph{Generalization of these functions by a Transformer} (Sections~\ref{sec:transformer}--\ref{sec:localization}).
  ...
  not in a brain.
\item \emph{The attainable degree of generalization} (Sections~\ref{sec:quantity}--\ref{sec:falsification}). The
  ...
  variable-depth models is the first concrete case. The account is falsified if, in a model whose
