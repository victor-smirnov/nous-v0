...
A component above the baseline is a hyperfunction, a component below it a deficit, and a component that
...
record of effort, because effort is constant, which is the dropped axis that S5 predicts for
givenness.
