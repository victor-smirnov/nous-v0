...
Three items are stated in the paper as open and are not needed by the reduction. A criterion for what
counts as a frame of consciousness in a substrate is not formulated: Section~\ref{sec:frames} gives
the components of a frame and Section~\ref{sec:incremental} its form, and without the criterion the
question whether the layers of a Transformer carry frames, or only the tokens do, stays open
(Section~\ref{sec:frame}). The three constructions of
