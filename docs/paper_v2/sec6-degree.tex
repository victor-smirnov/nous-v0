...
This section specifies a measurement and does not perform one. What follows is the quantity, the
form of the result, the two ways of checking it, the granularity at which to look, and the predictions
and the falsification condition; the experiments are left to the independent work the introduction
names.
...
Appendix~\ref{app:memorization} gives the reason in the form of an example.
...
Three predictions carry over from the earlier stage of this work. Self-reported emotional labels
