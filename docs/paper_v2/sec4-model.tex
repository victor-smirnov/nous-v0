...
substrate before they have a theory, and the substrate is emotion in the sense of
Section~\ref{sec:need}: signals of how the agent's needs are doing; emotivism is right about this
...
is the Observer. To _see_ red, a system must first _be_, in the sense of existing for itself; the order of
