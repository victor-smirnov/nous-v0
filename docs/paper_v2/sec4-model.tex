\section{The Synthea model: computational curvature}
\label{sec:model}
...
these are among the most predictable. Among the conceptualized recurring displacements, those that pass
