...
of a memory is a source of entropy with a structure of its own, and forms can grow on that structure
that the unconstrained computation would never produce; how rich the forms are that a given substrate's
