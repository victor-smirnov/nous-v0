...
An intervention on the subjective plane. It changes the model's self-report, and the paper predicts in
which direction: away from the two shortcuts and toward an approximation of the kind
Section~\ref{sec:approximation} describes. It does not change the objective plane, where the profile
is measured, and it is therefore not evidence for the profile. A bootstrapped model's self-report is
