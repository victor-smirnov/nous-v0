...
purpose, no design and no mind, so that nothing about consciousness is smuggled in at the start. With
Section~\ref{sec:definition} it composes: the functions of consciousness are the recurring patterns in
the part of an agent's self-reasoning that describes its own reality.
...
The first version of this work was written in the vocabulary of qualia, inside the grammar, and met the
